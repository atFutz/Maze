...
// added so H and W can be accessible to creature
int Maze::getHeight(){
  return Height;
}
int Maze::getWidth(){
...
// allows to check for location
// returns char in the location provided
char Maze::getField(int Row, int Col) const{
  return Field[Row][Col];
}